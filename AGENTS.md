...
> Identical to [CLAUDE.md](CLAUDE.md). Both files exist so that any coding agent
> finds the rules under the name it looks for. Keep them in sync; the parity is
> checked by `contracts/tests/test_ownership_docs.py`.
